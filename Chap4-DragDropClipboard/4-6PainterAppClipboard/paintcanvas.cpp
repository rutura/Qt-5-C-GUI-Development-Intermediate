...
void PaintCanvas::paste()
{
    ...
    if(mimeData->hasUrls()){
        ...
        if(isImage(file.absoluteFilePath())){
            ...
            painter.drawPixmap(QRect(10,10,300,300),mPix.scaled(300,300,
                                              Qt::KeepAspectRatio),QRect(0,0,300,300));
...
bool PaintCanvas::isImage(QString fullpath)
{
