...
class ResizableEllipseItem(QGraphicsRectItem, ResizableHandleRect):
    """Resizable ellipse item with corner handles"""
    ...
    def type(self):
        ...
        from painterapptypes import ResizableEllipseType
        return ResizableEllipseType
    ...
    def read_ellipse_item_from_stream(self, data_stream, item):
        ...
        # Set position with no offset for loading
