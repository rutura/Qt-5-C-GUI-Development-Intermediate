...
from person_edit_controller import PersonEditController
...
def run_widget():
    ...
    # Create controller
    controller = PersonEditController(model)
...
def run_quick():
    ...
    engine.rootContext().setContextProperty("personEditController", controller)
    
    # Load QML file
    qml_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), "personedit.qml")
