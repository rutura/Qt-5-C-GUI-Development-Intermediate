...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.removeFileDir = QPushButton(Widget)
        self.removeFileDir.setObjectName(u"removeFileDir")

        self.horizontalLayout.addWidget(self.removeFileDir)
    ...
    def retranslateUi(self, Widget):
        ...
        self.removeFileDir.setText(QCoreApplication.translate("Widget", u"Remove File or Dir", None))
    # retranslateUi
