...
class View(QGraphicsView):
    ...
    def __init__(self, parent=None):
        ...
        # Create an explicit QColor object instead of using Qt.yellow directly
        self.background_color = QColor(Qt.GlobalColor.yellow)
    ...
    def mousePressEvent(self, event):
        ...
        if isinstance(current_scene, Scene) and (current_scene.get_tool() == Scene.Cursor):
