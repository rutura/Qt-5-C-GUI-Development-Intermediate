...
class PersonModel(QAbstractTableModel):
    ...
    def __init__(self, parent=None):
        ...
        self.persons.append(Person("Jamie Lannister", "red", 33, 2, self))
        self.persons.append(Person("Marry Lane", "cyan", 26, 5, self))
        self.persons.append(Person("Steve Moors", "yellow", 44, 3, self))
        self.persons.append(Person("Victor Trunk", "dodgerblue", 30, 2, self))
        self.persons.append(Person("Ariel Geeny", "blue", 33, 4, self))
        self.persons.append(Person("Knut Vikran", "lightblue", 26, 3, self))
    ...
    def addPerson(self, person):
        ...
        self.setData(self.index(len(self.persons) - 1, 3), person.socialScore(), Qt.EditRole)
    
    def addPersonDefault(self):
        """Add a person with default values"""
        person = Person("Added Person", "yellowgreen", 45, 4, self)
        self.addPerson(person)
    
    def addPersonWithDetails(self, names, age, social_score):
        """Add a person with specified details"""
        person = Person(names, "yellowgreen", age, social_score, self)
        self.addPerson(person)
    ...
    def roleNames(self):
        ...
        roles[self.SocialScoreRole] = QByteArray(b"socialscore")
        return roles
