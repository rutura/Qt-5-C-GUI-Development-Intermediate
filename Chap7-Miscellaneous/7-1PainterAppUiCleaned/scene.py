...
class Scene(QGraphicsScene):
        ...
        try:
            ...
            if key is not None:
                if key == 10:  # Ellipse
                    ...
                    rect_item.setBrush(QBrush(Qt.gray))
                    ...
                    star_item.setFlags(QGraphicsItem.GraphicsItemFlag.ItemIsMovable | 
                                    QGraphicsItem.GraphicsItemFlag.ItemIsSelectable)
                    star_item.setBrush(QBrush(Qt.gray))
    ...
    def mouseReleaseEvent(self, event):
        ...
        if (event.button() == Qt.MouseButton.LeftButton) and self.drawing:
            ...
            if self.tool == self.Pen:
                ...
                m_rect.setBrush(QBrush(Qt.blue))
    ...
    def draw_line_to(self, end_point):
        ...
        m_pen = QPen()
        m_pen.setWidth(3)  # Hardcoded width as in C++ version
        m_pen.setColor(Qt.green)  # Hardcoded color as in C++ version
