    ...
    ui(new Ui::MainWindow)
{
    ...
    shapeMap.insert(10, tr("Ellipse"));
    shapeMap.insert(20, tr("Quick"));
    shapeMap.insert(30, tr("Rectangle"));
    shapeMap.insert(40, tr("Star"));

    QList<QString> shapeNames;
    shapeNames << "Ellipse" << "Quick" << "Rectangle" << "Star";

    for(int i = 0; i< shapeNames.count() ; i++){
        int key = shapeMap.keys()[i];
        QListWidgetItem * item = new QListWidgetItem(shapeMap[key],shapeList);
        QString filename = ":/images/" + shapeNames[i].toLower()+".png";
    ...
    ui->penStyleCombobox->addItem(QIcon(":/images/pen_style_solid.png") ,tr("Solid"));
    ui->penStyleCombobox->addItem(QIcon(":/images/pen_style_dashed.png"),tr("Dashed"));
    ui->penStyleCombobox->addItem(QIcon(":/images/pen_style_dotted.png"),tr("Dotted"));
    ui->penStyleCombobox->addItem(QIcon(":/images/pen_style_dot_dashed.png"),tr("Dot Dashed"));
    ...
    //Brush style combo
    ui->brushStyleComboBox->addItem(tr("Solid"));
    ui->brushStyleComboBox->addItem(tr("Dense"));
    ui->brushStyleComboBox->addItem(tr("Horizontal Lines"));
    ui->brushStyleComboBox->addItem(tr("Vertical Lines"));
    ui->brushStyleComboBox->addItem(tr("Cross Pattern"));
...
void MainWindow::on_actionCursor_triggered()
{
    ...
    setActiveTool(Scene::Cursor);
    statusBar()->showMessage(tr("Current tool is Cursor"));
...
void MainWindow::on_actionStar_triggered()
{
    ...
    statusBar()->showMessage(tr("Current tool is Star"));
...
void MainWindow::on_actionRectangle_triggered()
{
    ...
    statusBar()->showMessage(tr("Current tool is Rect"));
...
void MainWindow::on_actionEllipse_triggered()
{
    ...
    statusBar()->showMessage(tr("Current tool is Ellipse"));
...
void MainWindow::on_actionEraser_triggered()
{
    ...
    statusBar()->showMessage(tr("Current tool is Eraser"));
...
void MainWindow::on_actionPen_triggered()
{
    ...
    statusBar()->showMessage(tr("Current tool is Pen"));
