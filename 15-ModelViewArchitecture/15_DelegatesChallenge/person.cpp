...
int Person::socicalScore() const
{
    return m_socialScore;
}

void Person::setSocicalScore(int newSocicalScore)
{
    if(m_age == newSocicalScore)
        return;
    m_socialScore = newSocicalScore;
    emit socialScoreChanged(m_socialScore);
}
